    ...
    (function () {
      ...
      var snapshot = {
        ...
        lanes: [
          ...
          { id: 'claude', runner: 'claude', name: 'Claude Fable', detail: 'Judgment seat', evidenceLabel: 'Daily operator seat', state: 'available', roles: ['orchestrate','build','review','verify','assist'], permissions: ['read','write'], efforts: efforts, defaultEffort: 'default', contextCeiling: ceiling(1000000, 'native', 'fable') },
